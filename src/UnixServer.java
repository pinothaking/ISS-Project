...
public class UnixServer {
    public static void main(String[] args) throws Exception {
        ...
        try (ServerSocketChannel server = ServerSocketChannel.open(StandardProtocolFamily.UNIX)) { // building the socket of type unix
            ...
            try (SocketChannel client = server.accept()) { // waiting for a client to accept request
                ...
                /*
                 * Sending mesgs in string ( eventually we work with objs and values we need to modify )
                 * 
                 */
